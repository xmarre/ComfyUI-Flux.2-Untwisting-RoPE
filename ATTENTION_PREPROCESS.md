...
The H3 attention override exposes `attention_preprocess_v1 = (transform, previous_provider)` for optional numerical backends such as [Sol-H3](https://github.com/xmarre/ComfyUI-Sol-H3/pull/1).
...
CPU suite: 40 passed. Real combined GPU and audiovisual validation remains outstanding.
